...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/10 09:52:46 by ozaazaa           #+#    #+#             */
/*   Updated: 2020/12/10 14:16:25 by ozaazaa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef t_list_node			*t_list_add_function(t_list_head *head,
		void *content);
...
t_list_node					*ttslist_push(t_list_head *head,
		t_list_node *newnode);
t_list_node					*ttslist_push_front(t_list_head *head,
		t_list_node *newnode);
t_list_node					*ttslist_push_front_new(t_list_head *head,
		void *content);
t_list_node					*ttslist_push_new(t_list_head *head,
		void *content);
t_list_node					*ttslist_new_node(void *content,
		size_t content_size);
...
void						*ttslist_splice(t_list_head *head,
		t_list_node *node);
...
void						ttslist_purge(t_list_head *list,
		void (*purge)(void *));
int							ttslist_get_content_id(t_list_head *head,
		void *content);
int							ttslist_remove_node_with_content(t_list_head *list,
		void *content);
